...
function SelfTeam({ tone, label }: { tone: "red" | "blue"; label: string }) { return <div className="w-[58px] text-center"><SelfTeamMark tone={tone} size={40} className="mb-1.5" /><div className="text-[11px] font-bold text-muted">{label}</div></div>; }
