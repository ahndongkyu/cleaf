-- CLEAR FC 전체 스키마 (마이그레이션 0001~0010 통합) — 새 프로젝트 SQL Editor에 붙여넣고 Run

-- ===== 0001_init.sql =====
-- 수동 참조용 전체 스키마. 마이그레이션 실행 대상이 아닙니다.
-- ============================================================
-- CLEAR FC 초기 스키마 (members 로스터 + auth 연동 profiles + 도메인 테이블 + RLS)
